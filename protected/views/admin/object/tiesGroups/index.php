...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('app-models-object--ties-groups-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo \Yii::t('admin', 'TIES_GROUPS_LIST'); ?></h1>
...
<?php $this->widget('\app\components\core\GridView', array(
	'id' => 'app-models-object--ties-groups-grid',
	'dataProvider' => $model->search(),
	'filter' => $model,
	'cssFile'  =>  false,
	'itemsCssClass'  =>  'admin table table-striped',
	'columns' => array(
		array('name' => 'idobj_ties_groups', 'id' => 'table_id'),
		array('name' => 'name', 'id' => 'table_td'),
		array('name' => 'name', 'id' => 'table_td', 'value' => 'Yii::t("fields", $data->name);'),
