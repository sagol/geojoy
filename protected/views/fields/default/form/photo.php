<?php
	...
	$('#fileupload-$fieldName').fileupload({
		url: '$baseUrl/photoField/upload/ajax.html?name=$fieldName&id=$id&type=$type{$new}',
		autoUpload: true,
	...
	// Load existing files:
	$.getJSON('$baseUrl/photoField/upload/uploaded.html?name=$fieldName&id=$id&type=$type{$new}', function (result) {
...
<div class="control-group" id="fileupload-<?php echo $model->getName(); ?>">
