...
class CacheBlock extends \CFilterWidget {
	 ...
	 *
	 * Изменение логики обработки duration, теперь при duration = 0 возвращаются данные из кеша, а 
	 * удаление из кеша и отключение кеша убраны
	 */
	...
	protected function getCacheKey()
	{
		...
		else
		{
			...
			if($this->varyByValue !== null)
				$key .= serialize($this->varyByValue);
			$key .= '.';
